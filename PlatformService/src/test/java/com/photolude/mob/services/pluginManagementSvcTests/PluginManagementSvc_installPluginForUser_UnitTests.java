...
public class PluginManagementSvc_installPluginForUser_UnitTests {
	...
	public PluginManagementSvc_installPluginForUser_UnitTests(int pluginId, String userToken, boolean domainRetval, int expectedStatus)
	{
		...
		Mockito.when(domain.installPluginForUser(pluginId, userToken)).thenReturn(domainRetval);
	...
	@Test
	public void installPluginForUser()
	{
		Response response = this.service.installPluginForUser(this.pluginId, this.userToken);
