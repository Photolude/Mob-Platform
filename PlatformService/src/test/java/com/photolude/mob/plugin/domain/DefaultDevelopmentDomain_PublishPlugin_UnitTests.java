...
public class DefaultDevelopmentDomain_PublishPlugin_UnitTests {
	...
	public DefaultDevelopmentDomain_PublishPlugin_UnitTests(String companyName, Integer oldPluginId, Integer newPluginId, MainMenuItem[] previousMenuItems, Integer addMenuItemRetval, PluginScript[] previousScripts, Integer addScriptRetval, PluginDataCall[] previousDataCalls, Integer addDataCallRetval, boolean expectPluginDeletion, boolean expectCleanUp, boolean expectedResult)
	{
	...
	public void publishPlugin() throws Exception
	{
		...
		if(this.expectCleanUp)
		{
			...
			{
				Mockito.verify(this.pluginAccessLayer, times(0)).deleteMenuItem(anyInt());
			}
			...
			{
				Mockito.verify(this.pluginAccessLayer, times(0)).deleteScript(anyInt());
			}
